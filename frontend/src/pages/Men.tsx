...
export default function Men() {
  ...
  useMemo(() => {
    document.title = "StyleAI — Men's Collection";
  }, []);

  const filters = ["All", "Tops", "Pants", "Jackets", "Sale"];
    ...
    <div className="min-h-screen bg-[#0D0D0D] text-[#F5F0EB]" style={{ fontFamily: '"DM Sans", sans-serif' }}>
      ...
      <main className="container mx-auto px-4 py-16">
        <header className="mb-12 text-center">
          <h1 className="text-5xl font-serif mb-4" style={{ fontFamily: '"Playfair Display", serif' }}>Men's Collection</h1>
          <p className="text-[#A0A0A0] uppercase tracking-[0.3em] text-[10px] font-bold">Timeless Essentials & Modern Craftsmanship</p>
        </header>
