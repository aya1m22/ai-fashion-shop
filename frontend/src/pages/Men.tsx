...
export default function Men() {
  ...
  // STRICT gender filter: only gender="men" products
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="bg-white border-b border-stone-200">
        <div className="container py-10">
          ...
          <h1 className="font-display text-4xl font-bold text-stone-900 mb-1">Men's Fashion</h1>
          <p className="text-stone-500 text-sm">Shirts · Pants · Pajamas · Shoes · Accessories</p>
        </div>
      </div>
