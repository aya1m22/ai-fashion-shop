...
export const initialCatalog: CatalogProduct[] = [
  ...
  makeProduct(2022, "Gold Signet Ring", "Classic gold signet ring with a polished face. Complements warm and deep skin tones. A heritage-inspired accessory for confident styling.", "89.00", "men", "accessories", "https://images.unsplash.com/photo-1610384462494-06c8ba87d60f?w=600&q=80", ringSizes, { Gold: 5 }, ["ring", "gold", "signet", "heritage"]),
  makeProduct(2023, "Silver Band Ring", "Sleek silver band ring with a brushed finish. Pairs naturally with cool and neutral skin tones. Minimal and versatile.", "65.00", "men", "accessories", "https://images.unsplash.com/photo-1509315703195-529879416a7d?w=600&q=80", ringSizes, { Silver: 5 }, ["ring", "silver", "band", "minimal"]),
  makeProduct(2024, "Black Tungsten Ring", "Durable black tungsten ring with a high-polish finish. Bold statement piece for cool and deep skin tones.", "79.00", "men", "accessories", "https://images.unsplash.com/photo-1605342939943-34e2c842b03e?w=600&q=80", ringSizes, { Black: 5 }, ["ring", "black", "tungsten", "bold"]),
  makeProduct(2025, "White Gold Ring", "Elegant white gold-tone ring with a clean geometric profile. Versatile for warm, cool, and neutral skin tones.", "72.00", "men", "accessories", "https://images.unsplash.com/photo-1543209520-22c9e782bcbe?w=600&q=80", ringSizes, { White: 5 }, ["ring", "white", "geometric", "elegant"]),
];
