...
export const initialCatalog: CatalogProduct[] = [
  ...
  makeProduct(1008, "Linen Relaxed Shirt", "Breathable linen shirt with a relaxed fit. Perfect for warm days and casual weekend styling.", "61.00", "women", "shirts", "https://images.unsplash.com/photo-1598559069352-3d8437b0d42c?w=600&q=80", apparelSizes, { Beige: 4, White: 3, Olive: 2 }, ["linen", "casual", "summer"]),
  ...
  // ─── WOMEN'S PANTS ─────────────────────────────────────────────────────────
  makeProduct(1010, "High-Waist Tailored Trousers", "Structured high-waist trousers with a straight-leg cut. A wardrobe essential for polished looks.", "79.00", "women", "pants", "https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=600&q=80", apparelSizes, { Black: 5, Camel: 3, Gray: 3 }, ["tailored", "office", "classic"]),
  ...
  // ─── WOMEN'S PAJAMAS ───────────────────────────────────────────────────────
  makeProduct(1013, "Silk Pajama Set", "Luxurious silk-feel pajama set with piped trim. Includes long-sleeve top and matching pants for ultimate comfort.", "89.00", "women", "pajamas", "https://images.unsplash.com/photo-1598554747436-c9293d6a588f?w=600&q=80", apparelSizes, { Ivory: 4, Blush: 3, Navy: 3 }, ["silk", "luxury", "sleepwear"]),
  makeProduct(1014, "Cotton Floral Pajamas", "Soft cotton pajama set with a delicate floral print. Breathable and comfortable for all-night wear.", "58.00", "women", "pajamas", "https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=600&q=80", apparelSizes, { Pink: 4, Blue: 3, White: 3 }, ["cotton", "floral", "comfort"]),
  makeProduct(1015, "Satin Shorts Pajama Set", "Elegant satin pajama set with shorts and a button-up top. Perfect for warm nights.", "65.00", "women", "pajamas", "https://images.unsplash.com/photo-1582533561751-ef6f6ab93a2e?w=600&q=80", apparelSizes, { Champagne: 4, Black: 3, Lilac: 2 }, ["satin", "shorts", "summer-sleep"]),
  // ─── WOMEN'S BAGS ──────────────────────────────────────────────────────────
  ...
  makeProduct(2008, "Tailored Dress Trousers", "Sharp tailored trousers in a wool-blend fabric. Essential for formal and business attire.", "89.00", "men", "pants", "https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=600&q=80", apparelSizes, { Charcoal: 4, Black: 5, Navy: 3 }, ["tailored", "formal", "dress"]),
